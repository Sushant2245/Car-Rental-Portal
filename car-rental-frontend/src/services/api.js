...
export const carsAPI = {
  ...
  addReview: (carId, reviewData) =>
    apiRequest(`/cars/${carId}/reviews`, {
      method: "POST",
      body: JSON.stringify(reviewData),
    }),

  checkAvailability: (carId, dates) =>
    apiRequest(`/cars/availability/${carId}`, {
      method: "POST",
...
export const bookingsAPI = {
  ...
  updatePaymentStatus: (id, paymentStatus) =>
    apiRequest(`/bookings/${id}/payment`, {
      method: "PUT",
      body: JSON.stringify({ paymentStatus }),
    }),

  addBookingReview: (id, reviewData) =>
...
export const usersAPI = {
  ...
  getUserDashboardStats: () =>
    apiRequest("/users/stats/dashboard"),
};
